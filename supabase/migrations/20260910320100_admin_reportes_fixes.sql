-- ===========================================================================
-- REPORTES — fix: round(double precision, integer) no existe en Postgres
-- (round de 2 argumentos solo existe para numeric). extract(epoch from ...)
-- devuelve double precision — se castea a numeric antes de redondear.
-- Detectado por un test real (admin_reports_funnel fallaba en producción,
-- no solo en un caso límite). Sin ningún otro cambio a la función.
-- ===========================================================================
